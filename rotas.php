...
//try {
    ...
    SimpleRouter::get(URL_SITE . 'perfil', 'MatriculaControlador@perfil');
    SimpleRouter::post(URL_SITE . 'matricula/{course_id}', 'MatriculaControlador@matricularCurso');
    SimpleRouter::post(URL_SITE . 'cancelar/{course_id}', 'MatriculaControlador@cancelarMatricula');
